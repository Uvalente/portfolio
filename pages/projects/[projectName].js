...
const Project = ({ data, body, ...props }) => {
  ...
  return (
    <Layout pageTitle='uValente Projects NAME'>
      <div className='bg-dark-blue font-mono text-gray-100 py-24 px-10 md:flex md:justify-center' id='top'>
          ...
          <div className='mt-8 flex space-x-4'>
            ...
            <div className='flex h-full flex-col text-center'>
              ...
              <a href={data.url} target='_blank'>
                <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="external-link-alt" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="mt-1 w-16 h-auto text-dark-blue rounded-lg p-2 bg-gray-100 hover:bg-blue-800 transition-all duration-300"><path fill="currentColor" d="M432,320H400a16,16,0,0,0-16,16V448H64V128H208a16,16,0,0,0,16-16V80a16,16,0,0,0-16-16H48A48,48,0,0,0,0,112V464a48,48,0,0,0,48,48H400a48,48,0,0,0,48-48V336A16,16,0,0,0,432,320ZM488,0h-128c-21.37,0-32.05,25.91-17,41l35.73,35.73L135,320.37a24,24,0,0,0,0,34L157.67,377a24,24,0,0,0,34,0L435.28,133.32,471,169c15,15,41,4.5,41-17V24A24,24,0,0,0,488,0Z"></path></svg>
              </a>
            </div>
          </div>
          <Link href='/projects'>
